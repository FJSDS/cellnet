...
func getPackageByCodecName(name string) string {
	switch name {
	case "gorillaws.ltv":
		return "github.com/FJSDS/cellnet/proc/gorillaws"
	case "http":
		return "github.com/FJSDS/cellnet/proc/http"
	case "tcp.ltv":
		return "github.com/FJSDS/cellnet/proc/tcp"
	case "udp.ltv":
		return "github.com/FJSDS/cellnet/proc/udp"
	default:
